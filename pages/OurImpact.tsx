...
const OurImpact: React.FC = () => {
  ...
  return (
    <div className="pt-24 bg-white overflow-x-hidden">
      {/* Hero Section */}
      <section className="relative py-32 md:py-48 bg-slate-50 overflow-hidden border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          ...
          <h1 className="text-6xl md:text-9xl font-black text-slate-900 mb-10 leading-[0.9] tracking-tighter animate-fade-up">
            Powering <br />
      ...
      <section className="py-20 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 bg-white rounded-[3rem] overflow-hidden shadow-2xl shadow-indigo-100/50 border border-slate-100 animate-fade-up delay-200">
            <AnimatedCounter end={500000} suffix="+" title="Learners Trained" color="text-slate-900" />
            <AnimatedCounter end={150000} suffix="+" title="Careers Transformed" color="text-indigo-600" />
            <AnimatedCounter end={1000} suffix="+" title="Cities Reached" color="text-slate-900" />
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-24 animate-fade-up">
            ...
            <h3 className="text-5xl md:text-7xl font-black text-slate-900 tracking-tight">Experience <span className="text-indigo-600 italic">Growth.</span></h3>
          </div>
            ...
            <div className="group space-y-10 animate-fade-up hover:translate-y-[-10px] transition-transform duration-500">
              <div className="aspect-[4/5] rounded-[4rem] overflow-hidden relative shadow-2xl border border-slate-100">
                ...
                <div className="absolute bottom-12 left-10">
                  ...
                  <h4 className="text-3xl font-black text-white leading-tight">Hybrid <br />Learning</h4>
                </div>
              </div>
            ...
            <div className="group space-y-10 animate-fade-up delay-100 hover:translate-y-[-10px] transition-transform duration-500">
              <div className="aspect-[4/5] rounded-[4rem] overflow-hidden relative shadow-2xl border border-slate-100">
                ...
                <div className="absolute bottom-12 left-10">
                  ...
                  <h4 className="text-3xl font-black text-white leading-tight">Career <br />Mentorship</h4>
                </div>
              </div>
              <p className="text-slate-600 font-medium leading-relaxed px-6 border-l-2 border-indigo-100">
            ...
            <div className="group space-y-10 animate-fade-up delay-200 hover:translate-y-[-10px] transition-transform duration-500">
              <div className="aspect-[4/5] rounded-[4rem] overflow-hidden relative shadow-2xl border border-slate-100">
                ...
                <div className="absolute bottom-12 left-10">
                  ...
                  <h4 className="text-3xl font-black text-white leading-tight">Guaranteed <br />Placement</h4>
                </div>
              </div>
              <p className="text-slate-600 font-medium leading-relaxed px-6 border-l-2 border-indigo-100">
      ...
      {/* Experience Marquee - ANIMATED SUCCESS CONTENT */}
      <section className="py-32 bg-slate-900 overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 mb-20 relative z-10 text-center">
           <h2 className="text-indigo-400 font-black uppercase text-xs tracking-[0.4em] mb-4">Journey of Success</h2>
           <h3 className="text-4xl md:text-6xl font-black text-white italic tracking-tighter">The Tetron <span className="text-indigo-500">Experience</span></h3>
        </div>
        ...
        <div className="relative flex overflow-x-hidden group">
          <div className="py-12 animate-marquee flex whitespace-nowrap group-hover:pause-animation">
            {[...testimonials, ...testimonials].map((testi, i) => (
              <div 
                key={i} 
                className="mx-6 w-[400px] md:w-[550px] bg-white/5 backdrop-blur-xl p-10 rounded-[3rem] border border-white/10 flex flex-col hover:bg-white/10 transition-all duration-500 whitespace-normal"
              >
                <div className="mb-8">
                  <Quote className="text-indigo-500/20 w-16 h-16 mb-[-2.5rem]" />
                  <p className="text-indigo-100 text-lg leading-relaxed font-medium italic relative z-10">
                    "{testi.content}"
                  </p>
                </div>
                <div className="mt-auto flex items-center gap-5">
                  ...
                  <div>
                    <h5 className="font-black text-white text-lg tracking-tight">{testi.name}</h5>
                    <p className="text-[10px] font-black text-indigo-400 uppercase tracking-widest">{testi.role}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-20 animate-fade-up">
            ...
            <h3 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tighter">Our Hiring <span className="shimmer-text">Partners</span></h3>
          </div>
      ...
      <section className="py-32 px-4 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="bg-slate-900 rounded-[5rem] p-16 md:p-32 text-center text-white relative overflow-hidden shadow-2xl animate-fade-up">
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
            <div className="relative z-10">
              <Sparkles className="mx-auto mb-10 text-indigo-400 animate-pulse-soft" size={64} />
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-8">
                <Link to="/programs" className="px-16 py-6 bg-indigo-600 text-white rounded-2xl font-black text-xl hover:scale-110 transition-all shadow-2xl shadow-indigo-900/50">
                  Start Learning
                </Link>
                <Link to="/contact" className="px-16 py-6 bg-white text-slate-900 rounded-2xl font-black text-xl hover:scale-110 transition-all shadow-2xl">
                  Hire from Us
                </Link>
              </div>
            </div>
